...
<head>
    ...
    <!-- 加 载 样 式 -->
    <link rel="stylesheet" href="/static/pear/admin/css/loader.css" />
    <!-- 布 局 样 式 -->
...
<body class="layui-layout-body pear-admin">
        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="refresh layui-nav-item">
                    <a href="javascript:void(0);" class="layui-icon layui-icon-refresh-1" loading=600></a>
                </li>
            </ul>
            <!-- 多 系 统 菜 单 -->
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item user">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a user-menu-url="view/system/person.html" user-menu-id="5555"
    ...
    <!-- 框 架 初 始 化 -->
    <script>
        let configPath = {{ Js::from($configPath) }}
        ...
        layui.use(['admin', 'jquery', 'popup', 'drawer'], function() {
            ...
            admin.setConfigPath(configPath);
